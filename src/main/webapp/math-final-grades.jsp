...
<div>
    <h2 class="text-center mb-4">MATH FINAL GRADES</h2>
</div>
...
<div class="container">
    <table class="table table-striped" style="margin-top: 6rem;">
        ...
        <tbody>
        <c:forEach items="${studentMathFinal}" var="student" >
            <tr>
                ...
                <td><c:out value="${student.mathFinalGrade}"/></td>
                <td>
                    <div class="button">
                        <form action="${pageContext.request.contextPath}/update" method="get" style="display:inline;">
                            <input type="hidden" name="id" value="${student.id}"/>
                            <input type="hidden" name="updateButton" value="mathFinal"/>
