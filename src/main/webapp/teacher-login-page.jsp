...
<head>
    ...
    <script>
        function togglePasswordVisibility() {
            var passwordField = document.getElementById('teacherNumber');
...
<%
String emptyTeacherNumberError = (String) request.getAttribute("emptyTeacherNumberError");
...
<div class="login-container">
    ...
    <form action="teacher-login" method="post">
        <div class="input-container">
            <svg xmlns="http://www.w3.org/2000/svg"  class="icon number-icon  svg-icon" style="fill: currentColor;" viewBox="0 0 32 32" id="mail" >
        ...
        <button type="submit" class="loginButton">Teacher Login</button>
    </form>
    <div>
    ...
    <div class="newContainer">
        <div>
            <a href="<%=request.getContextPath()%>/forgot-teacher-number" class="forgotButton">
                Forgot Teacher Number
            </a>
        </div>
    </div>
</div>
