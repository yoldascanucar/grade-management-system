...
<div>
    <h2 class="text-center mb-4">PHYSICS FINAL GRADES</h2>
</div>
...
<div class="container">
    <table class="table table-striped" style="margin-top: 6rem;">
        ...
        <tbody>
        <c:forEach items="${studentPhysicsFinal}" var="student" >
            <tr>
                ...
                <td><c:out value="${student.physicsFinalGrade}"/></td>
                <td>
                    <div class="button">
                        <form action="${pageContext.request.contextPath}/update" method="get" style="display:inline;">
                            <input type="hidden" name="id" value="${student.id}"/>
                            <input type="hidden" name="updateButton" value="physicsFinal"/>
