...
<div>
    <h2 class="text-center mb-4">ENGLISH MIDTERM GRADES</h2>
</div>
...
<div class="container">
    <table class="table table-striped" style="margin-top: 6rem;">
        ...
        <tbody>
        <c:forEach items="${englishMidtermGrades}" var="student" >
            <tr>
                ...
                <td><c:out value="${student.englishMidtermGrade}"/></td>
                <td>
                    <div class="button">
                        <form action="${pageContext.request.contextPath}/update" method="get" style="display:inline;">
                            <input type="hidden" name="id" value="${student.id}"/>
                            <input type="hidden" name="updateButton" value="englishMidterm"/>
